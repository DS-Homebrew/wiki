...
### Anti-piratkopiering
AP (Anti-Piracy) is a method used by developers to enforce legitimate purchases and prevent piracy. Detta kan kringgås antingen från lastaren eller själva ROMen.
...
### CloneBoot
Cloneboot is when a game sends its own loaded ARM7 and ARM9 binaries to another console. Detta används av DS Download Play för flerspelarläge med ett kort. Not all games that have single-card multiplayer use cloneboot, however.
