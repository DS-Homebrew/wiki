...
- **DSi/3DS on SD Card + Flashcards with unlocked SCFG:** Only a few games require a Donor ROM to boot. Known ones that require it are *Eigo ga Nigate na Otona no DS Training: Eigo Zuke*, *Anpanman to Touch de Waku Waku Training*, *Professor Layton and the Last Specter/Spectre's Call* (Japanese version), and *Mimi's Party Fun*.
