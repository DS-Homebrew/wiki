...
- **DSi/3DS on SD Card + Flashcards with unlocked SCFG:** DSi-Enhanced games containing ARM7 binaries compiled in THUMB will require any TWL-type Donor ROM containing an ARM7 binary compiled in ARM, in order for the game to boot in DSi mode.
