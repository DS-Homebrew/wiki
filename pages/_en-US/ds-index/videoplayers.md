...
1. Download the .NET Desktop Runtime [here](https://dotnet.microsoft.com/en-us/download/dotnet/6.0), and install it
     - Once the page is opened, click `x64` under the `.NET Desktop Runtime` section
