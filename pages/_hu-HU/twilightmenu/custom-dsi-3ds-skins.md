...
| bubble        | The bottom bit of the bubble that draws over the start border or icon box                      | 8 szín                                                          |
...
| progress      | The progress loading animation with 8 frames                                                   | 9 szín                                                          |
| scroll_window | The part of the scrollbar that indicates the icons that are in view                            | 7 szín                                                          |
...
| wirelessicons | The icons displayed to indicate a game has wireless support                                    | 7 szín                                                          |
