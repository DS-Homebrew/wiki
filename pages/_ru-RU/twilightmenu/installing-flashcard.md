...
1. Откройте Настройки TWLMenu++, перейдите на страницу `Настройки nds-bootstrap`, и в пункте `Загрузчик игр` выберите `Ядро`, чтобы вместо nds-bootstrap использовалась прошивка флэш-картриджа
